...
<div class="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-8 max-w-3xl mx-auto mt-4">
    ...
    <div class="mb-8 flex items-center justify-between border-b border-gray-100 pb-5">
        <div class="flex items-center">
            ...
            <div>
                <h2 class="text-2xl font-black text-gray-900 tracking-tight">Form Tambah Mekanik</h2>
                <p class="text-gray-500 text-sm mt-1">Daftarkan mekanik baru untuk menangani servis kendaraan.</p>
            </div>
        </div>
    ...
    <form action="{{ route('admin.mechanics.store') }}" method="POST" class="space-y-6">
        ...
        <div class="relative z-20">
            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Nama Lengkap Mekanik <span class="text-red-500">*</span></label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
                    <i class="fas fa-user-tie"></i>
                </div>
                <input type="text" name="name" value="{{ old('name') }}" required placeholder="Contoh: Kang Asep"
                    class="w-full pl-11 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-bold text-gray-800 capitalize">
            </div>
        </div>
        ...
        <div class="relative z-10">
            ...
            <div class="relative">
                ...
                <input type="text" name="phone_number" value="{{ old('phone_number') }}" placeholder="Contoh: 08123456789"
                    class="w-full pl-11 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-bold text-gray-800">
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-100 mt-10">
            ...
            <button type="submit" class="flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white rounded-xl font-bold transition-transform transform hover:-translate-y-1 shadow-lg shadow-blue-500/30">
                <i class="fas fa-save"></i> Simpan Data Mekanik
            </button>
        </div>
    </form>
</div>
